...
void render()
{
    ...
    switch(globt) {
        ...
        case DIFF_SCALE_ORG:
        transform(Differential_Scale());
        break;

        case UNI_SCALE_POINT:
        transform(Uniform_Scale_Point());
        break;

        case DIFF_SCALE_POINT:
        transform(Differential_Scale_Point());
        break;
        ...
        case REF_Y:
        transform(Reflection(false));
        break;

        case REF_XY:
        transform(Reflection_XY());
        break;

        case REF_YX:
        transform(Reflection_YX());
        break;
        ...
        case SHEAR_X_POINT:
        transform(Shear_X_Point());
        break;

        case SHEAR_Y_POINT:
        transform(Shear_Y_Point());
        break;
    }
